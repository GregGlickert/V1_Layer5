...
from bmtool.connectors import num_prop
...
def build_input(t_stop=T_STOP, t_start=T_START, n_assemblies=N_ASSEMBLIES,
    ...
    nodes = util.load_nodes_from_config("config_baseline.json")
    pop_names = ['PN', 'FSI', 'LTS']
    ...
    for stim in stimulus:
        ...
        if stim == 'baseline':
            ...
            psg = get_psg_from_fr(psg, [Base_nodes['PN'],
    ...
    if 'shell' in nodes and 'baseline' in stimulus:
        ...
        edge_paths = util.load_config("config_baseline.json")['networks']['edges']
